...
- Bullets that leave the battlefield end in a small edge-clamped impact explosion. Player bullets also use the wall-hit sound at the border, while enemy bullets do not.
