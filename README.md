...
- Per-stage enemy sequences with configurable spawn points and active-enemy limits. A preferred enemy spawn point is tried first; if a tank occupies it, the other two points are tried in fixed order before the spawn enters its retry delay.
