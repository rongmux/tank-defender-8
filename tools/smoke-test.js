...
assert(enemyDestroyAudioLifecycleProbe.lethalHit.hit && enemyDestroyAudioLifecycleProbe.lethalHit.bulletRemoved && !enemyDestroyAudioLifecycleProbe.lethalHit.enemyAlive && enemyDestroyAudioLifecycleProbe.lethalHit.enemyKilled === 1 && enemyDestroyAudioLifecycleProbe.lethalHit.explosionCount === 2 && !enemyDestroyAudioLifecycleProbe.lethalHit.enemyHitActive, "a lethal shot should remove the enemy and avoid the surviving-armored-hit pulse cue");
...
assert(playerDestroyAudioLifecycleProbe.baseHit.active && playerDestroyAudioLifecycleProbe.baseHit.frame === 0 && playerDestroyAudioLifecycleProbe.baseHit.baseHitActive && playerDestroyAudioLifecycleProbe.baseHit.baseHitFrame === 0 && playerDestroyAudioLifecycleProbe.baseHit.baseHitAudible && playerDestroyAudioLifecycleProbe.baseHit.screen === "gameOver" && !playerDestroyAudioLifecycleProbe.baseHit.baseAlive && playerDestroyAudioLifecycleProbe.baseHit.bulletRemoved && playerDestroyAudioLifecycleProbe.baseHit.explosionCount === 1, "destroying the base should start player-explosion noise alongside the audible base cue");
assert(playerDestroyAudioLifecycleProbe.gameOverContinuation.active && playerDestroyAudioLifecycleProbe.gameOverContinuation.frame === 1 && playerDestroyAudioLifecycleProbe.gameOverContinuation.baseHitActive && playerDestroyAudioLifecycleProbe.gameOverContinuation.baseHitFrame === 1 && playerDestroyAudioLifecycleProbe.gameOverContinuation.screen === "gameOver", "both base-triggered destruction voices should continue over the game-over battlefield");
...
assert(baseHitAudioLifecycleProbe.triggered.hit && !baseHitAudioLifecycleProbe.triggered.baseAlive && baseHitAudioLifecycleProbe.triggered.bulletRemoved && baseHitAudioLifecycleProbe.triggered.explosionCount === 1 && baseHitAudioLifecycleProbe.triggered.playerDestroyActive && baseHitAudioLifecycleProbe.triggered.playerDestroyFrame === 0, "destroying the base should remove the bullet and start both original destruction events");
assert(baseHitAudioLifecycleProbe.triggered.screen === "gameOver" && baseHitAudioLifecycleProbe.triggered.movementAudioMode === "none", "base destruction should enter the game-over battlefield with movement audio silenced");
assert(baseHitAudioLifecycleProbe.gameOverContinuation.active && baseHitAudioLifecycleProbe.gameOverContinuation.frame === 1 && baseHitAudioLifecycleProbe.gameOverContinuation.playerDestroyActive && baseHitAudioLifecycleProbe.gameOverContinuation.playerDestroyFrame === 1, "both destruction events should continue on the game-over battlefield");
...
assert(!baseHitAudioLifecycleProbe.end.active && baseHitAudioLifecycleProbe.end.frame === 27 && baseHitAudioLifecycleProbe.end.screen === "gameOver", "base destruction audio should end exactly on frame twenty-seven");
