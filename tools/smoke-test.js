...
assert(tankDestructionExplosionProbe.enemy.length === 18 && tankDestructionExplosionProbe.player.length === 32, "tank destruction replacements should preserve their configured visible lifetimes");
