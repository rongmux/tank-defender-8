...
assert(titleDemoProbe.afterConstruction.screen === "title" && titleDemoProbe.afterConstruction.idleFrames === 2559, "using Construction should disable later automatic demos until reset");
keyPress("ArrowDown");
