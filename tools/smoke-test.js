...
assert(playerDestroyAudioLifecycleProbe.baseHit.active && playerDestroyAudioLifecycleProbe.baseHit.frame === 0 && playerDestroyAudioLifecycleProbe.baseHit.screen === "gameOver" && !playerDestroyAudioLifecycleProbe.baseHit.baseAlive && playerDestroyAudioLifecycleProbe.baseHit.bulletRemoved && playerDestroyAudioLifecycleProbe.baseHit.explosionCount === 1, "destroying the base should start the same player-explosion noise alongside the base cue");
assert(playerDestroyAudioLifecycleProbe.gameOverContinuation.active && playerDestroyAudioLifecycleProbe.gameOverContinuation.frame === 1 && playerDestroyAudioLifecycleProbe.gameOverContinuation.screen === "gameOver", "base-triggered player-explosion noise should continue over the game-over battlefield");
