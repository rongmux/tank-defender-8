(function (root, factory) {
  ...
  /** Composes explosion presentation and enemy-destruction probes in public API order. */
  function createEffectDiagnostics(state, deps) {
    ...
    const {
      ...
      createEffectExplosionDiagnostics,
      createEffectImpactDiagnostics
    } = scope;

    return Object.freeze({
      ...createEffectExplosionDiagnostics(scope),
      ...createEffectEnemyDestructionDiagnostics(scope),
      ...createEffectImpactDiagnostics(scope)
    });
  }
