(function () {
  ...
  var POWERUP_SIZE = deps.POWERUP_SIZE;
  ...
  var applyPowerUpStateEffect = deps.applyPowerUpStateEffect;
  ...
  var gridRectHitsSolidTerrain = deps.gridRectHitsSolidTerrain;
  var gridSolidTerrainOverlapArea = deps.gridSolidTerrainOverlapArea;
  ...
  var moveEditorCursor_rule = deps.moveEditorCursor;
  var calculateEnemySpawnDelay_rules = deps.calculateEnemySpawnDelay;
