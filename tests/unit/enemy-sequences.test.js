...
// Independent fixture transcribed from the original group-order/count tables.
...
const EXPECTED_ORIGINAL_ENEMY_TYPES = EXPECTED_ORIGINAL_ENEMY_GROUPS.map(expandGroups);
...
assert.deepEqual(ORIGINAL_STAGE_ENEMY_GROUPS, EXPECTED_ORIGINAL_ENEMY_GROUPS);
assert(Object.isFrozen(ORIGINAL_STAGE_ENEMY_GROUPS));
assert(ORIGINAL_STAGE_ENEMY_GROUPS.every((groups) =>
