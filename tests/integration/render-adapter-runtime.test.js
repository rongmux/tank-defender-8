...
const pipelineSource = fs.readFileSync(
  path.join(root, "src/runtime/render-pipeline-composition-runtime.js"),
  "utf8"
);
...
assert(pipelineSource.includes('setupRenderAdapterRuntime(state, deps'));
assert(pipelineSource.includes("connectRenderCompositionRuntime(renderCompositionRuntime, battleSceneRenderRuntime)"));
