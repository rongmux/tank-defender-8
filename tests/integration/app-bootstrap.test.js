...
(async () => {
  ...
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.battleSystemsCompositionRuntime), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.inputCommandRuntime), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.stageFlowTransitionDiagnostics), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.stageFlowProgressionDiagnostics), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.stageFlowGameOverDiagnostics), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.screenFlowNavigationDiagnostics), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.screenFlowTitleDemoDiagnostics), true);
  ...
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.powerUpPresentationDiagnostics), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.powerUpCollectionDiagnostics), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.powerUpSpawnDiagnostics), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.playerLifecycleGameOverDiagnostics), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.enemySpawnDiagnostics), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.timerFreezeDiagnostics), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.terrainBaseDiagnostics), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.effectExplosionDiagnostics), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.effectEnemyDestructionDiagnostics), true);
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.inputKeyboardRuntime), true);
  ...
  assert.equal(Object.isFrozen(context.window.TankDefender8Modules.combatPlayerFireInputDiagnostics), true);
